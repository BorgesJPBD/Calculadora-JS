...
function limparEntrada(){ atual='0'; mostrar(atual); }
function limparTudo(){ primeiro=null; operador=null; aguardandoSegundo=false; atual='0'; mostrar(atual); }
